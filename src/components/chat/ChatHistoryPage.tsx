      ...
      <div className="px-6 pt-6 pb-4">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
          />
          {searchQuery && (
        ...
        <div className="flex items-center gap-2" ref={filterRef}>
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs rounded-lg border cursor-pointer
              active:scale-95
              transition-all duration-150 ease-out
              ${showFilters || filterCharacterId !== 'all'
                ? 'border-violet-300 dark:border-violet-600 bg-violet-50 dark:bg-violet-900/20 text-violet-700 dark:text-violet-300 hover:shadow-sm'
          ...
          <div className="flex items-center gap-1 ml-auto">
            ...
            <button
              ...
              className={`px-2 py-1 text-xs rounded transition-colors ${
                sortBy === 'date' ? 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300' : 'text-gray-400'
              }`}
            >
              时间
            </button>
            <button
              ...
              className={`px-2 py-1 text-xs rounded transition-colors ${
                sortBy === 'messages' ? 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300' : 'text-gray-400'
              }`}
            >
              消息数
            </button>
                ...
                <div className="pb-3 flex flex-wrap gap-1.5">
                  <button
                    ...
                    className={`px-2.5 py-1 text-xs rounded-full cursor-pointer
                      ...
                      transition-all duration-150 ease-out
                      ${filterCharacterId === 'all'
                        ? 'bg-violet-600 text-white hover:bg-violet-500 shadow-sm hover:shadow active:shadow-inner'
                        : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 hover:-translate-y-px hover:shadow active:shadow-inner'
                      }`}
                  >
                    全部
                  </button>
            ...
            {filtered.map((conv) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-full bg-violet-100 dark:bg-violet-800/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <button
                      ...
                      title={confirmDelete === conv.id ? '确认删除' : '删除'}
                    >
                      <Trash2 size={14} />
                    </button>
                  </div>
        ...
        <div className="px-5 py-4 flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full flex items-center justify-center overflow-hidden flex-shrink-0" style={{ backgroundColor: characterAvatar ? 'transparent' : undefined }}>
                {characterAvatar ? (
                  ...
                  <div className="w-full h-full bg-violet-100 dark:bg-violet-800/30 flex items-center justify-center">
                    <span className="text-sm font-medium text-violet-600 dark:text-violet-300">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="搜索此对话..."
              className="w-full pl-7 pr-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-xs text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-violet-500"
            />
          </div>
        </div>
          ...
          <div className="flex items-center gap-1.5 mb-0.5">
            <div className="w-5 h-5 rounded-full overflow-hidden flex-shrink-0">
              {characterAvatar ? (
                ...
                <div className="w-full h-full bg-violet-100 dark:bg-violet-800/30 flex items-center justify-center">
                  <span className="text-[8px] font-medium text-violet-600 dark:text-violet-300">{characterName.charAt(0)}</span>
                </div>
              )}
            </div>

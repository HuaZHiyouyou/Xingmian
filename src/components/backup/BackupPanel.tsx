...
import { Download, Upload, RotateCcw, Trash2, Plus, Clock, Database, Shield, AlertTriangle, HardDrive, FileDown, FileUp, ArrowLeft, X, Check } from 'lucide-react';
                ...
                <div className="space-y-3 pl-1 animate-[fadeUp_0.15s_ease-out]">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-24 px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-center font-medium text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-1 focus:ring-violet-500 tabular-nums [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    />
                  </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-1 ml-3 shrink-0">
                    <button
                      ...
                      className="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400 hover:text-violet-500 transition-colors"
                      title="导出备份文件"
                    >
                      <FileDown size={14} />
                    </button>

    ...
    >
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={handleSave}
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-700 hover:bg-slate-700 text-white text-sm font-medium transition-colors"
          >
            <Save size={16} />
            保存
          </button>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-slate-700"
              placeholder="角色名称"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-3 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm text-gray-900 dark:text-gray-100 font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-slate-700 resize-y"
              rows={30}
